...
public class Esp extends SimState {
	...
	public void start()
    {
        ...
        forces = new Network();
        forceMap.put("A", new BodyForce("A", w_1,  l_1, -h_1, 1E-3, Color.GREEN, 0.1, 0.01, 0.01));
        forceMap.put("B", new BodyForce("B",-w_2,  l_1, -h_1, 1E-3, Color.GREEN, 0.1, 0.01, 0.01));
        forceMap.put("C", new BodyForce("C",-w_2, -l_2, -h_1, 1E-3, Color.GREEN, 0.1, 0.01, 0.01));
        forceMap.put("D", new BodyForce("D", w_1, -l_2, -h_1, 1E-3, Color.GREEN, 0.1, 0.01, 0.01));
	...
	public void createForceNodeEdge(BodyForce bf, Double3D startLocation)
	{
        ...
        bf.edgeX = new Edge(bf.fromNodeObject, bf.toNodeXObject, bf);
        bf.edgeY = new Edge(bf.fromNodeObject, bf.toNodeYObject, bf);
        bf.edgeZ = new Edge(bf.fromNodeObject, bf.toNodeZObject, bf);
	...
	public MutableDouble2D simpleBeam(double F, double a, double b)
	{
		return new MutableDouble2D( F*b/(a+b), F*a/(a+b) );
	}
